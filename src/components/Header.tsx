...
const Header = ({ onToggleTheme }: HeaderProps) => {
    return <header 
        className={`h-[55px] absolute top-0 right-0 left-0 flex justify-between items-center px-[10px] pl-[20px] bg-[var(--neutral)] transition-all duration-300 ease-in-out`}>
