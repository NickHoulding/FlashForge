...
const ChatBox = ({ onSendMessage }: ChatBoxProps) => {
    ...
    return <div className="relative left-1/2 -translate-x-1/2 flex flex-col gap-[10px] w-full max-w-[750px] h-fit max-h-[200px] p-[10px] pt-0 mb-[10px] box-border bg-[var(--accent)] border border-[var(--secondary)] rounded-[20px]">
        <textarea
        ...
        <div className="flex justify-between">
            <div className="flex flex-row gap-[10px]">
                <button className="font-[Satoshi-Medium] text-[0.85rem] text-[var(--primary)] flex items-center justify-center w-[35px] h-[35px] bg-transparent border border-[var(--secondary)] rounded-[10px] box-border hover:bg-[var(--secondary)] cursor-pointer" id="file-button">
                ...
                <button className="font-[Satoshi-Medium] text-[0.85rem] text-[var(--primary)] flex items-center justify-center w-fit h-[35px] bg-transparent border border-[var(--secondary)] rounded-[10px] box-border hover:bg-[var(--secondary)] px-[10px] gap-[5px] cursor-pointer" id="export-button">
                    <svg fill="currentColor" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="flex flex-row gap-[10px]">
                <select
                    ...
                    className="font-[Satoshi-Medium] text-[0.85rem] bg-transparent text-[var(--primary)] border border-[var(--secondary)] rounded-[10px] w-[115px] pl-[10px] pr-[25px] box-border appearance-none transition-colors hover:bg-[var(--secondary)] cursor-pointer"
                    style={{
                ...
                <button onClick={sendUserQuery} className="font-[Satoshi-Medium] text-[0.85rem] flex items-center justify-center w-[35px] h-[35px] bg-[var(--secondary)] text-[var(--primary)] border border-[var(--secondary)] rounded-[10px] hover:bg-[var(--primary)] hover:text-[var(--neutral)] cursor-pointer">
                    <svg fill="currentColor" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
